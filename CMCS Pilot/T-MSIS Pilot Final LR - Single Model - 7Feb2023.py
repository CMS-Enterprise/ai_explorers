...
# MAGIC %sql
# MAGIC create or replace table datalab_scratch.lr_test_forecast_2_kv using delta
# MAGIC as
...
# MAGIC      , comments
# MAGIC   from datalab_scratch.lr_test_forecast_1_kv
...
# MAGIC %sql select * from datalab_scratch.lr_test_forecast_2_kv

# COMMAND ----------

# MAGIC %sql
# MAGIC create or replace table datalab_scratch.lr_train_forecast_2_kv using delta
# MAGIC as
# MAGIC select model_run_type
# MAGIC      , model_run_num
# MAGIC      , state_code_numeric
...
# MAGIC   from datalab_scratch.lr_train_forecast_1_kv
# MAGIC -- where model_run_num = 3
# MAGIC --   and state_code_numeric = '44'
# MAGIC --   and file_type = 'COT'
...
# MAGIC %sql select * from datalab_scratch.lr_train_forecast_2_kv
...
# MAGIC %sql
# MAGIC select * from datalab_scratch.lr_final_forecast_kv
...
# MAGIC %sql
# MAGIC update datalab_scratch.lr_final_forecast_kv
# MAGIC    set source_data_table_name = 'datalab_scratch.lr_final_forecast_kv'
# MAGIC    
...
# MAGIC %sql
# MAGIC update datalab_scratch.lr_final_forecast_kv
# MAGIC    set source_notebook_url = 'https://databricks-val-data.macbisdw.cmscloud.local/#notebook/2783134/command/2830675'
